...
foreach ($chartConfigs as $key => $config) {
    $chartConfigs[$key]['cover_url'] = resolvePublicAssetUrl($config['cover']);
}
?>
<!DOCTYPE html>
<html lang="zh-CN">
        ...
        <article class="topchart-reference-card <?php echo htmlspecialchars($config['theme']); ?> <?php echo $key === $activeChart ? 'is-active' : ''; ?>">
          <a class="topchart-reference-main" href="top_songs.php?chart=<?php echo urlencode($key); ?>">
            <div class="topchart-reference-cover">
              ...
              <img src="<?php echo htmlspecialchars($config['cover_url']); ?>" alt="cover">
...
<script type="text/javascript" src="<?php echo htmlspecialchars(siteAssetUrl('js/jquery-2.1.4.min.js')); ?>"></script><script type="text/javascript" src="<?php echo htmlspecialchars(siteAssetUrl('js/bootstrap-3.1.1.min.js')); ?>"></script>
